...
def benchmark_model(model, tokenizer, dataset, input_size=448):
    ...
    for sample in tqdm(dataset, desc="Benchmarking Samples"):
        image_paths = [Path(data_path) / "droid_3_3_1_single_turn_combined_48/data/" / img_path for img_path in sample["image"]]
...
if __name__ == "__main__":
    ...
    dataset_file = f"{data_path}/droid_3_3_1_single_turn_combined_48/data/dataset.jsonl"
