...
OUTPUT_DIR='work_dirs/internvl_chat_v2_0/internvl2_1b_qwen2_0_5b_dynamic_res_2nd_finetune_lora_droid'
...
torchrun \
  ...
  --meta_path "./shell/data/droid_3_1_1_single_turn_432.json" \
